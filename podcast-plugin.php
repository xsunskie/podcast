	...
	*/
	...
	public function dx_custom_taxonomies_callback() {
		register_taxonomy( 'pluginbase_taxonomy', 'pluginbase', array(
			'hierarchical' => true,
			'labels' => array(
				'name' => _x( "Taxonomies", 'taxonomy general name', 'dxbase' ),
				'singular_name' => _x( "Taxonomy", 'taxonomy singular name', 'dxbase' ),
				'search_items' =>  __( "Search Taxonomies", 'dxbase' ),
				'popular_items' => __( "Popular Taxonomies", 'dxbase' ),
				'all_items' => __( "All Taxonomies", 'dxbase' ),
				'parent_item' => null,
				'parent_item_colon' => null,
				'edit_item' => __( "Taxonomy", 'dxbase' ), 
				'update_item' => __( "Update Taxonomy", 'dxbase' ),
				'add_new_item' => __( "Add New Taxonomy", 'dxbase' ),
				'new_item_name' => __( "New Taxonomy Name", 'dxbase' ),
